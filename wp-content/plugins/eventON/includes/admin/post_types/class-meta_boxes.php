...
class evo_event_metaboxes{
	...
	// MAIN META BOX CONTENT
		function event_edit_tax_section($tax, $eventid){
			$event_tax_term = wp_get_post_terms($eventid, $tax);

			$tax_name = str_replace('event_', '', $tax);
								...
								<div class='evcal_data_block_style1'>
									...
									<div class='evcal_db_data'>
										<div class='evcal_location_data_section'>										
											...
											<?php
												echo $this->event_edit_tax_section('event_location',$p_id);
											?>
											</div>									
										</div>
							...
							case 'ev_organizer':
								...
								<div class='evcal_data_block_style1'>
									...
									<div class='evcal_db_data'>
										...
										<?php
											echo $this->event_edit_tax_section('event_organizer',$p_id);
										?>
										</div>
